...
export const NavBar = () => {
  ...
  return (
    <div className={`text-white text-xl px-12 py-5 fixed top-0 left-0 right-0 z-10 flex items-center justify-between z-20 ${colorChnage ? 'bg-gray-900 transition-all duration-800' : 'bg-transparent'}`}>
      ...
      <div className="relative hidden md:block w-[55vh]">
      ...
      <div className='flex gap-8'>
        <button type="button" className="text-white text-[2vh] bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Login</button>
