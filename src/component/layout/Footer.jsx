        ...
        <footer className="bg-white dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-center">
                    <div className="grid grid-cols-2 gap-8 sm:gap-48 sm:grid-cols-3">
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://gauravshreenet.com/" target="_blank" className="hover:underline">Gaurav Shreenet™</a>. All Rights Reserved.
                    </span>
